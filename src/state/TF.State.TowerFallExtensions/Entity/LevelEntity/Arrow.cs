...
namespace TF.State.TowerFallExtensions.Entity.LevelEntity
{
    public static class ArrowExtensions
    {
        public static Arrow GetState(this TowerFall.Arrow entity)
        {
            ...
            builder.WithFlash(new TF.State.Domain.Models.Entity.LevelEntity.Flash
            {
            ...
            switch (entity.ArrowType)
            {
                ...
                case TowerFall.ArrowTypes.Bramble:
                    ...
                    var liveSpread = dynBrambleArrow.Get<TF.State.Domain.Models.BrambleSpreadState>("BrambleSpread");
