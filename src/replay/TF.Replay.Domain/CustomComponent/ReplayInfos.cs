...
namespace TF.Replay.Domain.CustomComponent
{
    public class ReplayInfos : MenuItem
    {
        ...
        public ReplayInfos(MainMenu mainMenu, Vector2 position, Models.Replay replay, Action confirmAction) : base(position)
        {
        ...
        public ReplayInfos(MainMenu mainMenu, Vector2 position, Models.Replay replay, Action confirmAction, ReplaysPanel entity) : this(mainMenu, position, replay, confirmAction)
        {
            _panel = entity;
        }
        ...
        public void Reenable() => _isDisabled = false;
