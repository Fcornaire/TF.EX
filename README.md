...
| ------------------------- | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `INPUT DELAY`             | `20`       | Local input delay in ms (0-332, steps of 4). Less delay plays better but rollbacks more, more delay rollbacks less but feels clunky. Find your sweetspot                                                                                                                                                                                                                                                                                                                                       |
| `AUTO ADJUST INPUT DELAY` | `PROPOSE`  | Adapts the input delay to the connection when joining a lobby: `PROPOSE` shows a slider at the top right of the lobby with the suggested value marked in blue (half the laggiest player's ping minus your `ACCEPTED ROLLBACK`, rounded up). Drag it with the mouse, or hold the button shown next to it (LB on a pad) and press LEFT/RIGHT; hold that button alone for 1.5 s to go back to your saved value. `ENABLED` applies the suggestion automatically. Your saved value is never changed |
| `ACCEPTED ROLLBACK`       | `2`        | How many frames of rollback you accept, in 60 fps frames (0-6, one frame is about 17 ms). The suggested delay is the no-rollback value minus this. `0` suggests a delay that never rolls back                                                                                                                                                                                                                                                                                                  |
